...
# {"north":[0.0015,0.0681],"south":[0,0.0152]}
```
...
# [INFO] Loading coefs
# [INFO] 2021-07-24 06:13:10 Starting server: http://0.0.0.0:8080
# [INFO] Making predictions for species AlderFlycatcher (birds)
```
...
It is advised to add the Docker background process to systemd or use a
Docker Compose in production. Docker Compose can

-   better handle container restarts
-   don’t have to expose the container port beyond the bridge network
